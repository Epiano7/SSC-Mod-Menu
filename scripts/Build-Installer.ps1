...
if($RuntimeDirectory) {
    ...
    $approved=@{'opengl32.dll'='F0E5D76142BE70EE7EC24BA363BFBD890E38C1294FDC5AF0DDDD7EBD30FF7F64';'runtime.dll'='75FE8264DBB094C546C26C96D36D1F0C08FC3696F990427295D318B9003FE9F8'}
